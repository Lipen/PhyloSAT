...
tests: test_easiest test_easy test_folded qwerty4 qwerty5 test_simple test_intermediate
test_easiest:
...
test_intermediate:
	${PY} run.py test_intermediate.trees network_test_intermediate ${EXTRA}
test_medium:
	${PY} run.py test_medium.trees network_test_medium ${EXTRA}
test_hard:
	${PY} run.py test_hard.trees network_test_hard ${EXTRA}
...
test_easiest_np:
	${PY} run.py test_easiest.trees network_test_easiest -np -h 1 ${EXTRA}
qwerty4_np:
	${PY} run.py qwerty4.trees network_qwerty4 -np -h 1 ${EXTRA}
qwerty5_np:
	${PY} run.py qwerty5.trees network_qwerty5 -np -h 2 ${EXTRA}
test_simple_np:
	${PY} run.py test_simple.trees network_test_simple -np -h 3 ${EXTRA}
test_medium_np:
	${PY} run.py test_medium.trees network_test_medium -np -h 5 ${EXTRA}
test_hard_np:
	${PY} run.py test_hard.trees network_test_hard -np -h 7 ${EXTRA}

Grass3NdhfRpocWaxy_np:
	${PY} run.py ${DIR_GRASS3}/Grass3NdhfRpocWaxy.tree.restrict.num network_Grass3NdhfRpocWaxy -np -h 3 ${EXTRA}
...
Grass2NdhfWaxy_np:
	${PY} run.py ${DIR_GRASS2}/Grass2NdhfWaxy.tree.restrict.num network_Grass2NdhfWaxy -np -h 6 ${EXTRA}
Grass2PhytRbcl_np:
	${PY} run.py ${DIR_GRASS2}/Grass2PhytRbcl.tree.restrict.num network_Grass2PhytRbcl -np -h 4 ${EXTRA}
Grass2PhytRpoc_np:
	${PY} run.py ${DIR_GRASS2}/Grass2PhytRpoc.tree.restrict.num network_Grass2PhytRpoc -np -h 4 ${EXTRA}
Grass2PhytWaxy_np:
	${PY} run.py ${DIR_GRASS2}/Grass2PhytWaxy.tree.restrict.num network_Grass2PhytWaxy -np -h 3 ${EXTRA}
Grass2RbclWaxy_np:
	${PY} run.py ${DIR_GRASS2}/Grass2RbclWaxy.tree.restrict.num network_Grass2RbclWaxy -np -h 4 ${EXTRA}
Grass2RpocWaxy_np:
	${PY} run.py ${DIR_GRASS2}/Grass2RpocWaxy.tree.restrict.num network_Grass2RpocWaxy -np -h 2 ${EXTRA}
Grass2WaxyIts_np:
	${PY} run.py ${DIR_GRASS2}/Grass2WaxyIts.tree.restrict.num network_Grass2WaxyIts -np -h 5 ${EXTRA}
